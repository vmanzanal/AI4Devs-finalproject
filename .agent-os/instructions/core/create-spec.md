...
Use the file-creator subagent to create directory: .agent-os/specs/YYYY-MM-DD-NN-spec-name/ using the date from step 4 and a sequential number.

Use kebab-case for spec name. Maximum 5 words in name.

<folder_naming>
<format>YYYY-MM-DD-NN-spec-name</format>
<date>use stored date from step 4</date>
<sequential_number> 1. CHECK .agent-os/specs/ directory for existing folders with same date (YYYY-MM-DD) 2. IDENTIFY highest sequential number (NN) for that date 3. INCREMENT by 1 for new spec 4. FORMAT as two-digit number (01, 02, 03, etc.) 5. IF no specs exist for date, START with 01
</sequential_number>
...
- 2025-03-15-01-password-reset-flow
- 2025-03-15-02-user-profile-dashboard
- 2025-03-17-01-api-rate-limiting
  </example_names>

<sequential_logic>
EXAMPLE SCENARIO:
Existing specs: - 2025-10-19-01-database-template-fields - 2025-10-19-02-api-integration

New spec on 2025-10-19:
Next number = 03
Result: 2025-10-19-03-new-feature-name

New spec on 2025-10-20:
Next number = 01 (new date)
Result: 2025-10-20-01-another-feature
</sequential_logic>
...
Use the file-creator subagent to create the file: .agent-os/specs/YYYY-MM-DD-NN-spec-name/spec.md using this template:
...
Use the file-creator subagent to create the file: .agent-os/specs/YYYY-MM-DD-NN-spec-name/spec-lite.md for the purpose of establishing a condensed spec for efficient AI context usage.
...
<file_template>
  ...
  <header>
    ...
    This is the technical specification for the spec detailed in @.agent-os/specs/YYYY-MM-DD-NN-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the database schema implementation for the spec detailed in @.agent-os/specs/YYYY-MM-DD-NN-spec-name/spec.md
...
<file_template>
  ...
  <header>
    ...
    This is the API specification for the spec detailed in @.agent-os/specs/YYYY-MM-DD-NN-spec-name/spec.md
...
- Spec Requirements: @.agent-os/specs/YYYY-MM-DD-NN-spec-name/spec.md
- Spec Summary: @.agent-os/specs/YYYY-MM-DD-NN-spec-name/spec-lite.md
- Technical Spec: @.agent-os/specs/YYYY-MM-DD-NN-spec-name/sub-specs/technical-spec.md
